...
class _$AuthResponseTearOff {
  ...
  _AuthResponse call({bool isUser = false, User? user}) {
...
abstract class $AuthResponseCopyWith<$Res> {
  ...
  $Res call({bool isUser, User? user});
...
class _$_AuthResponse implements _AuthResponse {
  _$_AuthResponse({this.isUser = false, this.user});
  ...
  @override
  String toString() {
    return 'AuthResponse(isUser: $isUser, user: $user)';
  }
...
abstract class _AuthResponse implements AuthResponse {
  factory _AuthResponse({bool isUser, User? user}) = _$_AuthResponse;
